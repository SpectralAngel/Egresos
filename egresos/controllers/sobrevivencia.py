...
class Sobrevivencia(controllers.Controller, identity.SecureResource):
    ...
    def agregar(self, afiliado, **kw):
        ...
        flash(u'Se ha agregado el Beneficio de Sobrevivencia al afiliado %s %s %s' % (afiliado.id, afiliado.nombre, afiliado.apellidos))
    ...
    def eliminar(self, sobrevivencia):
        ...
        flash(u'Se ha eliminado el Beneficio de Sobrevivencia al afiliado %s' % afiliado.id)
